...
//		Thread.sleep(2000);
		 Wait wait=new FluentWait(driver).withTimeout(5, TimeUnit.SECONDS).pollingEvery(1, TimeUnit.SECONDS).ignoring(Exception.class);
		...
		List<WebElement> selectCars1=selectSkill.getAllSelectedOptions();
		System.out.println("Selected car count: "+selectCars1.size());
	}
}
